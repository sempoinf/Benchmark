...
{
  int length=max-min;
  int* counting_array = (int*)calloc((length + 1), sizeof(int));   /*массив с количеством вхождений каждого элемента исходного         массива. размер этого массива - это разница между наибольшим и наименьшим целыми числами исходного массива + 1.*/
  int k=0;
